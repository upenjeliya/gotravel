...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference("Itinerary.count") do
      post itineraries_url, params: { itinerary: { destination_id: @itinerary.destination_id, name: @itinerary.name, price: @itinerary.price, url: @itinerary.url } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { destination_id: @itinerary.destination_id, name: @itinerary.name, price: @itinerary.price, url: @itinerary.url } }
